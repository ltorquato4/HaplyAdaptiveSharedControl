...
def generate_controller_summary_plots(df, controller, behaviors, output_dir, limits):
    ...
    for i in range(3):
        ...
        if i < len(ordered_behaviors):
            ...
            if not summary.empty:
                ...
                ax.fill_between(mean_nx, mean_ny - std_ny, mean_ny + std_ny, color=beh_color, alpha=0.2, zorder=4, label= r"$1\pm$SD")
    ...
    if handles:
        ...
        desired_order = ['Start', 'End', 'Reference', 'Run Trajectories', r"$1\pm$SD", 'Mean']
